...
//	}
//
//	private static void test(long a, long b, int bitSize) {
//		long la = a & bit.getMask();
//		long lb = b & bit.getMask();
//		BitNumber ao = BitNumber.valueOf(la, bit);
//		BitNumber bo = BitNumber.valueOf(lb, bit);
...
//	}
//
//	private static void ok(BigInteger a, BitNumber b, String msg) {
